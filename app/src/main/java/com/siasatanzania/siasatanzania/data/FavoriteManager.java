...
import com.siasatanzania.siasatanzania.FavoriteActivity;
...
public class FavoriteManager implements LocalItemManager<Favorite> {
    ...
    @VisibleForTesting static final String FILE_AUTHORITY = "com.siasatanzania.siasatanzania.fileprovider";
