## Materialistic for Habari Tanzania
Material design [Habari Tanzania] client for Android, uses official [HackerNews/API], [Dagger] for dependency injection and [Robolectric] for unit testing.
...
**Dependencies**
- [Official Habari Tanzania API][HackerNews/API], user services (e.g. login/create account/vote/comment) rely on redirect requests to Habari Tanzania website
- [Algolia Habari Tanzania Search API]
...
[Habari Tanzania]: https://news.ycombinator.com/
...
[Algolia Habari Tanzania Search API]: https://github.com/algolia/hn-search
